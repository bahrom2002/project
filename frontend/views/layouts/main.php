                    ...
                    <div class="col-12 d-flex flex-wrap align-items-center justify-content-between">
                        <div class="main-nav d-flex align-items-center flex-grow-1 me-4">
                            <nav class="navbar navbar-expand-lg nav-dark nav-primary-hover w-100">
                                <a class="navbar-brand" href="/site/index"><img class="nav-logo" src="/source/images/logo/2.png" alt="Image not found !"></a>
                                            ...
                                            <ul class="cart_list woocommerce-mini-cart product_list_widget">
                                                <li class="woocommerce-mini-cart-item mini_cart_item">
                                                    ...
                                                    <a class="mini_cart_item_image product-image bg-light" href="/site/index">
                                                        <img src="/source/images/thumb/square-1.png" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" width="300" height="300">
                                                    </a>
                                                ...
                                                <li class="woocommerce-mini-cart-item mini_cart_item">
                                                    <a href="/site/index" class="remove remove_from_cart_button" aria-label="Remove this item">×</a>
                                                    <a class="mini_cart_item_image product-image bg-light" href="/site/index">
                                                        <img src="/source/images/thumb/square-1.png" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" loading="lazy" width="300" height="300">
                                                    </a>
            ...
            <div class="row gy-5">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-8">
                    <div class="footer-widget widget_fliker_photo">
                        ...
                        <ul>
                            <li>
                                <a href="/source/images/gallery/8.png" data-fancybox="gallery" data-caption="Caption for single image"><img src="/source/images/gallery/8.png" alt=""></a>
                            </li>
                            <li>
                                <a href="/source/images/gallery/9.png" data-fancybox="gallery" data-caption="Caption for single image"><img src="/source/images/gallery/9.png" alt=""></a>
                            </li>
                            <li>
                                <a href="/source/images/gallery/10.png" data-fancybox="gallery" data-caption="Caption for single image"><img src="/source/images/gallery/10.png" alt=""></a>
                            </li>
                            <li>
                                <a href="/source/images/gallery/11.png" data-fancybox="gallery" data-caption="Caption for single image"><img src="/source/images/gallery/11.png" alt=""></a>
                            </li>
                            <li>
                                <a href="/source/images/gallery/12.png" data-fancybox="gallery" data-caption="Caption for single image"><img src="/source/images/gallery/12.png" alt=""></a>
                            </li>
                            <li>
                                <a href="/source/images/gallery/13.png" data-fancybox="gallery" data-caption="Caption for single image"><img src="/source/images/gallery/13.png" alt=""></a>
                            </li>
                        </ul>
                    </div>
                </div>
